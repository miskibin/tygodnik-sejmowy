...
export default function Landing() {
  ...
  return (
    <div className="bg-background font-serif text-foreground">
      {/* Above-the-fold hero — tagline + form in one band, no scroll required */}
      ...
      <section className="max-w-[1100px] mx-auto px-4 md:px-8 lg:px-14 py-14 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
        {[
          {
            n: "I",
            h: "Tygodnik dla Ciebie",
            b: "Każdy piątek po posiedzeniu — 3 do 7 rzeczy z Sejmu, dopasowanych do Twojego życia, w prostym polskim. Z wyraźnym „co możesz teraz zrobić”.",
            cta: "Zobacz przykład →",
            href: "/tygodnik",
          },
          {
          ...
          <article key={c.n} className="border-t border-rule pt-5">
            <div className="font-serif italic text-[26px] text-destructive leading-none mb-2">{c.n}.</div>
            <h3 className="font-serif text-[20px] font-medium tracking-tight m-0 mb-2.5 leading-snug">{c.h}</h3>
            <p className="font-sans text-[13.5px] leading-[1.55] text-secondary-foreground m-0 mb-3.5">{c.b}</p>
            <a
              href={c.href}

  ...
  return (
    <main className="bg-background text-foreground px-4 sm:px-8 md:px-14 pt-10 sm:pt-12 pb-24 sm:pb-28">
      <div className="max-w-[900px] mx-auto">
        ...
        <div className="flex flex-wrap gap-4 mb-10 text-[12px] text-muted-foreground tracking-wide font-medium">
        ...
        <h2 className="font-medium text-[24px] mb-4 pb-2 border-b border-rule">
          Posłowie ({mps.length})
        </h2>

        {mps.length === 0 ? (
          <p className="text-muted-foreground">Brak posłów w bazie dla tego okręgu.</p>
        ) : (
